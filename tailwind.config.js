...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['Cobe', 'Outfit', 'sans-serif'],
        heading: ['Cobe', 'Syne', 'sans-serif'],
      },
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px rgba(116,30,168,0.3)' },
          '50%': { boxShadow: '0 0 40px rgba(116,30,168,0.6), 0 0 80px rgba(116,30,168,0.2)' },
        },
        borderGlow: {
          '0%, 100%': { borderColor: 'rgba(116,30,168,0.2)' },
          '50%': { borderColor: 'rgba(147,51,208,0.4)' },
        },
      },
      boxShadow: {
