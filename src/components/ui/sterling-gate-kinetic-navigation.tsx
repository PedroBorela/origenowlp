...
/** Extracted to reduce cognitive complexity of the menu useEffect */
function animateMenuOpen(
  navWrap: Element | null,
  menu: Element | null,
  overlay: Element | null,
  bgPanels: NodeListOf<Element>,
  menuLinks: NodeListOf<Element>,
  fadeTargets: NodeListOf<Element>,
  menuButtonTexts: NodeListOf<HTMLParagraphElement> | undefined,
  menuButtonIcon: Element | null | undefined
) {
  if (navWrap) (navWrap as HTMLElement).dataset.nav = "open";
...
function animateMenuClose(
  ...
  if (navWrap) (navWrap as HTMLElement).dataset.nav = "closed";
...
export function Component() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Shape Hover — extracted into setupShapeHover to reduce nesting depth
      const menuItems = containerRef.current!.querySelectorAll(".menu-list-item[data-shape]");
      const shapesContainer = containerRef.current!.querySelector(".ambient-background-shapes");

      menuItems.forEach((item) => setupShapeHover(item, shapesContainer));
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (isMenuOpen) {
        animateMenuOpen(navWrap, menu, overlay, bgPanels, menuLinks, fadeTargets, menuButtonTexts, menuButtonIcon);
      } else {
        animateMenuClose(navWrap, menu, overlay, menuButtonTexts, menuButtonIcon);
      }
  ...
  return (
    <div ref={containerRef}>
      {/* Logo — scrolls with the page, positioned at the top of the hero */}
      <div className="nav-logo-static absolute top-0 left-0 w-full h-[80px] flex items-center z-50 pointer-events-none">
        <div className="container is--full">
          <a href="#hero" aria-label="home" className="nav-logo-row w-inline-block pointer-events-auto">
            <motion.img
              ...
              whileHover={{
                scale: 1.04,
                filter: "drop-shadow(0px 0px 10px rgba(147, 51, 208, 0.5))",
            ...
            <div className="menu-content-wrapper">
              <ul className="menu-list">
                ...
                <li className="menu-list-item" data-shape="2">
                  <a href="#funcionalidades" className="nav-link w-inline-block" onClick={closeMenu}>
                    <p className="nav-link-text">Funcionalidades</p>
                    <div className="nav-link-hover-bg"></div>
                  </a>
                </li>
                <li className="menu-list-item" data-shape="3">
                  <a href="#resultados" className="nav-link w-inline-block" onClick={closeMenu}>
                    <p className="nav-link-text">Resultados</p>
                    <div className="nav-link-hover-bg"></div>
                  </a>
                </li>
                <li className="menu-list-item" data-shape="4">
                  <a href="#faq" className="nav-link w-inline-block" onClick={closeMenu}>
                    <p className="nav-link-text" data-menu-fade>FAQ</p>
                    <div className="nav-link-hover-bg"></div>
                  </a>
                </li>
                <li className="menu-list-item" data-shape="5">
                  <a href="#blog" className="nav-link w-inline-block" onClick={closeMenu}>
