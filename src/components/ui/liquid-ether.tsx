...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: dtVal, isBounce: isBounceVal, BFECC: BFECCVal }: any) {
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous: viscousVal, iterations, dt: dtVal }: any) {
        let fbo_in, fbo_out;
    ...
    class Pressure extends ShaderPass {
      ...
      update({ vel, pressure: pressureVal }: any) {
        this.uniforms.velocity.value = vel.texture;
  ...
  return <div ref={mountRef} className={`relative overflow-hidden w-full h-full touch-none ${className || ''}`} style={style} />;
}
