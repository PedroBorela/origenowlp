...
const DotMaterial = shaderMaterial(
    {
        ...
        hoverColor: new THREE.Color('#9333D0'),
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      vec3 finalColor = mix(dotColor, hoverColor, min(mouseInfluence * 4.0, 1.0));

      // Mix background color with dot color, using animated opacity to increase visibility
      vec3 composition = mix(bgColor, finalColor, smoothDot * combinedMask * dotOpacity * (1.0 + opacityInfluence));
...
function Scene() {
    ...
    useEffect(() => {
        ...
        dotMaterial.uniforms.hoverColor.value.set(themeColors.hoverColor)
