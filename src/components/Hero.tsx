...
export default function Hero() {
  return (
    <section id="hero" className="relative pt-[80px] bg-[#130624] pb-10 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container-custom px-4 md:px-6 relative z-10 flex flex-col items-center justify-center">
        <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center mt-16 mt-[-80px]">
          ...
          {/* Heading */}
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] md:leading-[1.15] tracking-tight mb-8 opacity-0 animate-slide-up-delay-1 text-white">
          ...
          {/* Subtitle */}
          <p className="text-white/80 text-lg sm:text-xl max-w-2xl mb-12 lg:mb-16 leading-relaxed opacity-0 animate-slide-up-delay-2">
